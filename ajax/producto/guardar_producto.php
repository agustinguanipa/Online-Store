<?php
	...
	if ($imag1_prod == '')
	{
		$destino1 = "../../imagen/productos/product.jpg";
	}

	if ($imag2_prod == '')
	{
		$destino2 = "../../imagen/productos/product.jpg";
	}

	if ($imag3_prod == '')
	{
		$destino3 = "../../imagen/productos/product.jpg";
	}

	$sql = "INSERT INTO tabma_prod(ident_prod, ident_cate, ident_prov, nombr_prod, desco_prod, desla_prod, preci_prod, pesoo_prod, taman_prod, stock_prod, estad_prod, imag1_prod, imag2_prod, imag3_prod, statu_prod) VALUES ('$ident_prod','$ident_cate','$ident_prov','$nombr_prod','$desco_prod','$desla_prod','$preci_prod','$pesoo_prod','$taman_prod','$stock_prod','$estad_prod','$destino1','$destino2','$destino3','$statu_prod')";
