<?php
  ...
  $estad_prod = mysqli_real_escape_string($con,(strip_tags($_POST["edit_estad_prod"],ENT_QUOTES)));
	$ident_prod=intval($_POST['edit_id']);

    $sql = "UPDATE tabma_prod SET ident_cate='".$ident_cate."', nombr_prod='".$nombr_prod."', desco_prod='".$desco_prod."', desla_prod='".$desla_prod."', preci_prod='".$preci_prod."', pesoo_prod='".$pesoo_prod."', taman_prod='".$taman_prod."', stock_prod='".$stock_prod."', estad_prod='".$estad_prod."' WHERE ident_prod='".$ident_prod."' ";
