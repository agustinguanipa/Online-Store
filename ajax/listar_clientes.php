...
if($action == 'ajax'){
	...
	$tables="tabma_clie";
	$campos="*";
	$sWhere=" (tabma_clie.nomb1_clie LIKE '%".$query."%' OR tabma_clie.nomb2_clie LIKE '%".$query."%' OR tabma_clie.apel1_clie LIKE '%".$query."%' OR tabma_clie.apel2_clie LIKE '%".$query."%') AND tabma_clie.statu_clie = 1";
			...
			<tbody>	
					...
					<tr class="">
						...
						<td class='text-center'>
							<a href="#"  data-target="#lookClienteModal" class="look" data-toggle="modal" data-nomb1_clie="<?php echo $nomb1_clie?>" data-nomb2_clie="<?php echo $nomb2_clie?>" data-apel1_clie="<?php echo $apel1_clie?>" data-apel2_clie="<?php echo $apel2_clie?>" data-gener_clie="<?php echo $gener_clie?>" data-telef_clie="<?php echo $telef_clie?>" data-email_clie="<?php echo $email_clie?>" data-usuar_clie="<?php echo $usuar_clie?>" data-fecre_clie="<?php echo $fecre_clie?>" data-ident_clie="<?php echo $ident_cliente; ?>"><i class="fa fa-eye" data-toggle="tooltip" title="Ver" ></i></a>
	          </td>
						<td class='text-center'>
