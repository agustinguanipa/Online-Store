...
-- Tiempo de generación: 04-02-2020 a las 17:06:54
...
CREATE TABLE `tabma_prod` (
  ...
  `preci_prod` float DEFAULT NULL,
  `pesoo_prod` float DEFAULT NULL,
  `taman_prod` float DEFAULT NULL,
...
(1, 'CARLOS', 'AGUSTIN', 'GUANIPA', 'ALVAREZ', 'MASCULINO', '(0426) 690 8396', 'AGUSTINGUANIPA98@GMAIL.COM', '../../imagen/perfil/user.png', 'AGUSTIN', '827ccb0eea8a706c4c34a16891f84e7b', '2020-02-04 17:05:26', '1', 1);
...
--
ALTER TABLE `tabma_cate`
  MODIFY `ident_cate` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tabma_prov`
  MODIFY `ident_prov` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tabma_usua`
--
ALTER TABLE `tabma_usua`
  MODIFY `ident_usua` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
