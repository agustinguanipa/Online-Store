...
CREATE TABLE IF NOT EXISTS `sigmaos_bd`.`tabma_cate` (
  ...
  `statu_cate` CHAR(1) NULL,
  PRIMARY KEY (`ident_cate`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sigmaos_bd`.`tabma_prov`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigmaos_bd`.`tabma_prov` (
  `ident_prov` INT(10) NOT NULL AUTO_INCREMENT,
  `nombr_prov` VARCHAR(50) NULL,
  `telef_prov` VARCHAR(15) NULL,
  `email_prov` VARCHAR(100) NULL,
  `direc_prov` VARCHAR(100) NULL,
  `statu_prov` CHAR(1) NULL,
...
CREATE TABLE IF NOT EXISTS `sigmaos_bd`.`tabma_prod` (
  ...
  INDEX `fk_tabma_prov1_idx` (`ident_prov` ASC),
  CONSTRAINT `fk_tabla_cate1`
    FOREIGN KEY (`ident_cate`)
    REFERENCES `sigmaos_bd`.`tabma_cate` (`ident_cate`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tabma_prov1`
    FOREIGN KEY (`ident_prov`)
    REFERENCES `sigmaos_bd`.`tabma_prov` (`ident_prov`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sigmaos_bd`.`tabma_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigmaos_bd`.`tabma_tipo` (
  `ident_tipo` INT(2) NOT NULL,
  `nombr_tipo` VARCHAR(20) NULL,
  PRIMARY KEY (`ident_tipo`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sigmaos_bd`.`tabma_usua`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigmaos_bd`.`tabma_usua` (
  `ident_usua` INT(10) NOT NULL AUTO_INCREMENT,
  `nomb1_usua` VARCHAR(20) NULL,
  `nomb2_usua` VARCHAR(20) NULL,
  `apel1_usua` VARCHAR(20) NULL,
  `apel2_usua` VARCHAR(20) NULL,
  `gener_usua` VARCHAR(10) NULL,
  `telef_usua` VARCHAR(15) NULL,
  `email_usua` VARCHAR(100) NULL,
  `usuar_usua` VARCHAR(20) NULL,
  `contr_usua` VARCHAR(20) NULL,
  `fecre_usua` DATE NULL,
  `statu_usua` CHAR(1) NULL,
  `ident_tipo` INT(2) NOT NULL,
  PRIMARY KEY (`ident_usua`),
  INDEX `fk_tabma_tipo1_idx` (`ident_tipo` ASC),
  CONSTRAINT `fk_tabma_tipo1`
    FOREIGN KEY (`ident_tipo`)
    REFERENCES `sigmaos_bd`.`tabma_tipo` (`ident_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sigmaos_bd`.`tabtr_orde` (
  ...
  CONSTRAINT `fk_tabla_clie2`
    ...
    REFERENCES `sigmaos_bd`.`tabma_usua` (`ident_usua`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
