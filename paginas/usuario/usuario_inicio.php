  ...
  <div class="container">
    <div class="form-group text-center">
      <div class="formulario-registro-inicio">
        <form role="form" id="usuario_inicio" class=" justify-content-center" align="center" action="../usuario/usuario_autenticacion.php" method="post">
          ...
          <p class="text-center">No Tienes una Cuenta? <a href="../cliente/cliente_registro.php">Registrarse</a> </p>
        </form>
      </div> 
    </div>
  </div>
