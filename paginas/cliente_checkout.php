        ...
        <div class="col-sm-3 form-group">
          <div class="card">
            ...
            <div class="card-footer">
              <a href="cliente_listar_orden.php" class="btn btn-success"><i class="fa fa-check"></i> Realizar Orden</a>
              <a href="cliente_direccion.php" class="btn btn-primary float-left"><i class="fa fa-arrow-circle-left"></i> Volver</a>
            </div>
          </div>
        </div>
      </div>
