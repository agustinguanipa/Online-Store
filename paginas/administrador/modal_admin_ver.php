...
<div class="modal fade" id="lookAdministradorModal" aria-labelledby="lookAdministradorModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="lookAdministradorModal">Ver Usuario</h4>
