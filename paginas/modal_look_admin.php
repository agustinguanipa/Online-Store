        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="col form-group">
              ...
              <input type="text" name="look_nomb1_admi" id="look_nomb1_admi" class="form-control" disabled>
              <input type="hidden" name="look_id" id="look_id">
            </div>
            <div class="col form-group">
              <label class="form-label"><b>Segundo Nombre: </b></label>
              <input type="text" name="look_nomb2_admi" id="look_nomb2_admi" class="form-control" disabled>
            </div>
          </div>
          <div class="form-row">
            <div class="col form-group">
              <label class="form-label"><b>Primer Apellido: </b></label>
              <input type="text" name="look_apel1_admi" id="look_apel1_admi" class="form-control" disabled>
            </div>
            <div class="col form-group">
              <label class="form-label"><b>Segundo Apellido: </b></label>
              <input type="text" name="look_apel2_admi" id="look_apel2_admi" class="form-control" disabled>
            </div>
          </div>
          <div class="form-row">
            <div class="col form-group">
              <label class="form-label"><b>Usuario: </b></label>
              <input type="text" name="look_usuar_admi" id="look_usuar_admi" class="form-control" disabled>
            </div>
          </div>
        </div>
