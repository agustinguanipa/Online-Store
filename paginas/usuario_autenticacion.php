<?php
	...
	if ($stmt = $con->prepare('SELECT u.ident_usua, u.contr_usua, u.nomb1_usua, u.apel1_usua, u.ident_tipo, r.ident_tipo, r.nombr_tipo FROM tabma_usua u INNER JOIN tabma_tipo r ON u.ident_tipo = r.ident_tipo WHERE u.usuar_usua = ?')) {
	...
	if ($stmt->num_rows > 0) {
		$stmt->bind_result($ident_usua, $contr_usua, $nomb1_usua, $apel1_usua, $ident_tipo, $ident_tipo, $nombr_tipo);
		$stmt->fetch();
